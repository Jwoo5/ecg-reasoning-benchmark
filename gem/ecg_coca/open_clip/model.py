...
class CLIPTextCfg:
    ...
    # Additional parameters found in config files
    proj: Optional[str] = None
    pooler_type: str = 'mean_pooler'
    masked_language_modeling: bool = False
    fusedLayerNorm: bool = True
...
class CLIPEcgCfg:
    ...
    head_width: int = 64
    mlp_ratio: float = 4.0
    patch_size: Union[int, Tuple[int, int]] = 50
    seq_length: int = 5000
    lead_num: int = 12
    ...
    # Additional parameters found in config files
    ecg_size: Optional[Tuple[int, int]] = None  # Alternative way to specify seq_length and lead_num
    global_average_pool: bool = False
    n_queries: int = 256  # Alternative name for attn_pooler_queries
    heads: int = 8  # Alternative name for number of heads
...
def _build_ecg_tower(
    ...
    # Handle patch_size conversion from list to int if needed
    patch_size = ecg_cfg.patch_size
    if isinstance(patch_size, (list, tuple)):
        patch_size = patch_size[0]  # Use the first element for 1D convolution
