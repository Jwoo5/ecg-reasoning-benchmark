...
from ..llm.TimeSeriesFlamingoWithTrainableEncoder import (
    TimeSeriesFlamingoWithTrainableEncoder,
)
from models.opentslm.open_flamingo.open_flamingo.src.flamingo_lm import FlamingoLMMixin
from models.opentslm.open_flamingo.open_flamingo.src.utils import extend_instance
import torch
import torch._dynamo
from typing import List, Dict, Tuple
from transformers import AutoTokenizer, AutoModelForCausalLM

from models.opentslm.model_config import ENCODER_OUTPUT_DIM
from .TimeSeriesLLM import TimeSeriesLLM
from models.opentslm.prompt.full_prompt import FullPrompt
from models.opentslm.time_series_datasets.util import (
    extend_time_series_to_match_patch_size_and_aggregate,
)

# Monkey-patch FlamingoLayer to add attention_type property for compatibility with newer transformers
from models.opentslm.open_flamingo.open_flamingo.src.flamingo_lm import FlamingoLayer
