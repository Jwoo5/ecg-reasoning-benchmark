...
@register_model("ecg-r1-hf")
class ECGR1HFModel(BaseModel):
    def __init__(
        self, model_variant: str = "RL"
    ):
        self.model_variant = model_variant

        model_id = f"PKUDigitalHealth/ECG-R1-8B-{model_variant}"
    ...
    @classmethod
    def build_model(cls, model_variant="RL", **kwargs):
